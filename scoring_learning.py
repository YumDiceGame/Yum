...
for episode in range(1, NUM_EPISODES):
    ...
    while not all_scored:
        ...
        ##### Replace with scoring_reward ------>

        reward = scoring_reward(scored_cat, scored_amount, myDice, score, max_die_count, face_max_die_count, can_yum,
                                can_full, can_straight, reward)
        #
        # if can_yum:
        #     if scored_cat == 'Yum':
        #         reward += 200
