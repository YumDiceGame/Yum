...
NUM_EPISODES = 6_500_000
START_EPSILON_DECAYING = 500_000  # was 100_000 for a lot
...
ACTION_60 = 60
MASK_OUT_KEEP = [1] * NUM_KEEPING_ACTIONS
MASK_OUT_SCORE = [1] * NUM_SCORE_CATEGORIES
NUM_TOTAL_ACTIONS = NUM_KEEPING_ACTIONS + NUM_SCORE_CATEGORIES
